...
import com.webmarke8.app.gencart.Objects.Category;
import com.webmarke8.app.gencart.Objects.Store;
import com.webmarke8.app.gencart.R;

import java.util.List;

public class Categories_ResturentAdapter extends RecyclerView.Adapter<Categories_ResturentAdapter.ViewHolder> {
    ...
    public Categories_ResturentAdapter(Context context, List<Store> models) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.personName.setText("Chinese");
